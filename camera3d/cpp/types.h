...
#define EVec4d Eigen::Vector4d
#define EVec4f Eigen::Vector4f
#define EVec4i Eigen::Vector4i
#define EVec3d Eigen::Vector3d
#define EVec3f Eigen::Vector3f
#define EVec3i Eigen::Vector3i
#define EVec2d Eigen::Vector2d
#define EVec2f Eigen::Vector2f
#define EVec2i Eigen::Vector2i

#define EMatrix22f Eigen::Matrix<float, 2, 2, Eigen::RowMajor>
#define EMatrix33f Eigen::Matrix<float, 3, 3, Eigen::RowMajor>
#define EMatrix34f Eigen::Matrix<float, 3, 4, Eigen::RowMajor>
#define EMatrix43f Eigen::Matrix<float, 4, 3, Eigen::RowMajor>
#define EMatrix44f Eigen::Matrix<float, 4, 4, Eigen::RowMajor>
